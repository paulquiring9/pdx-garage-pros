    ...
    <main className="bg-white text-[#00482B]">
        ...
        <div className="grid gap-10 md:grid-cols-[1.3fr_0.7fr]">
          ...
          <aside className="h-fit space-y-5">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
              ...
              <a
                href="tel:+15034953464"
                className="mt-4 block rounded-xl bg-[#00482B] px-5 py-3 text-center font-bold text-white hover:bg-[#003d22]"
              >
                Call (503) 495-3464
              </a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            href="tel:+15034953464"
            className="rounded-xl bg-slate-900 px-6 py-4 text-center font-bold text-white hover:bg-[#003d22]"
          >
            Call (503) 495-3464
          </a>
          <Link
