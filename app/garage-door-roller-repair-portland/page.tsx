      ...
      <section className="border-b border-slate-200 bg-slate-950 text-white">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <h1 className="max-w-3xl text-4xl font-bold tracking-tight md:text-6xl">
            Garage Door Roller Repair in Portland
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
            Garage door roller repair in Portland for worn, noisy, broken, or off-track rollers that make the door rough, loud, or unsafe to operate.
          </p>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:grid-cols-[1.3fr_0.7fr]">
        <div>
          ...
          <p className="mt-4 text-lg leading-8 text-slate-700">
            Garage door rollers guide the door through the track. When rollers wear out, crack, seize, or pop out of position, the door can become noisy, jerky, uneven, or more likely to come off track.
          </p>
          ...
          <ul className="mt-5 grid gap-3 text-slate-700 sm:grid-cols-2">
              <li>Door sounds rough or rattly</li>
              <li>Rollers look cracked or worn</li>
              <li>Door shakes while moving</li>
              <li>Rollers have popped out of track</li>
              <li>Door sticks in one spot</li>
