      ...
      <section className="border-b border-slate-200 bg-slate-950 text-white">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <h1 className="max-w-3xl text-4xl font-bold tracking-tight md:text-6xl">
            Garage Door Won’t Close in Portland
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
            Garage door won’t close in Portland? Get help with sensor issues, track problems, opener limits, broken springs, and doors that reverse or stay open.
          </p>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:grid-cols-[1.3fr_0.7fr]">
        <div>
          ...
          <p className="mt-4 text-lg leading-8 text-slate-700">
            A garage door that will not close can come from several different issues. The most common causes are blocked or misaligned safety sensors, opener travel-limit problems, track obstructions, damaged rollers, broken springs, or cable problems that keep the door from moving evenly.
          </p>
          ...
          <ul className="mt-5 grid gap-3 text-slate-700 sm:grid-cols-2">
              <li>Door starts closing, then reverses</li>
              <li>Opener light flashes</li>
              <li>Door closes only if you hold the wall button</li>
              <li>Door stops a few inches from the floor</li>
              <li>Sensors look misaligned or dirty</li>
              <li>Door is crooked, jammed, or unusually loud</li>
          </ul>

          <h2 className="mt-10 text-3xl font-bold tracking-tight">Related repair issues to check</h2>
          <p className="mt-4 text-lg leading-8 text-slate-700">
            If the door reverses before it reaches the floor, start by looking at the safety sensors and track area. If the door is also crooked, loud, or hard to move by hand, it may connect to a roller, cable, spring, or off-track issue instead of a simple opener setting.
          </p>
